...
const PopUp = () => {
    return <div className="flx flx-jc-ce flx-ai-ce p-20 w-80 h-10 brd-ln">
...
const Body = (props)=>{
    ...
    return <div className="flx flx-col flx-jc-sa flx-ai-ce p-20 h-80 w-80">
        <img src="./imgAus/greet.png" alt="jackpot" className="w-80"/>
        <div className="brd-ln flx flx-col flx-ai-ce flx-jc-sa m-t-2 p-20 h-80">
...
const Greet = (props)=>{
    ...
    return <section className="flx flx-col flx-jc-sa flx-ai-ce h-100 w-50 fade-t bg-side">
        <PopUp/>
